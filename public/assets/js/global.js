...
var DY = {
    ...
    gnbMenuShowHide: function gnbMenuShowHide() {
        // GNB 메뉴
    ...
    gnbSearchShowHide: function gnbSearchShowHide() {
        // 검색버튼
    ...
    mainPersonalInfoShowHide: function mainPersonalInfoShowHide() {
        // 메인 개인정보 영역
    ...
    mainNoticeInfoShowHide: function mainNoticeInfoShowHide() {
        // 메인 하단 공지
    ...
    tabFunction: function tabFunction() {
    ...
    contentAliveHeight: function contentAliveHeight() {
        // 컨텐츠 이동 후 navigation indicator
        var nowsection = $('#sectionSliderWrapper .swiper-slide-active');
        var value = nowsection.data('id');
        var gnbNum = nowsection.data('gnb');
        var subNum = nowsection.data('sub');
        ...
        $('.sub-menus a').each(function (i) {
            ...
            if (i === subNum) {
                //section height
                var nowsectionHeight = $('#sectionSliderWrapper .swiper-slide-active > div.section-inner').height();
                $(this).addClass('active');
                //section move top
